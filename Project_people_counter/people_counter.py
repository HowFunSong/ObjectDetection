...
# x1 , y1 , x2 , y2
limits_down = [430, 297, 595, 297]
limits_up = [170, 297, 330, 297]
totalCount_down = []
totalCount_up = []
...
while True:
    ...
    cv2.putText(img,str(len(totalCount_down)),(455,100),cv2.FONT_HERSHEY_PLAIN,5,(50,50,255),8)
    cv2.putText(img,str(len(totalCount_up)),(195,100),cv2.FONT_HERSHEY_PLAIN,5,(50,50,255),8)
